...
type CountryPropsType = {
    ...
    addMoney: (filterValue:BanknotsType)=>void
    removeMoney: (filterValue:BanknotsType)=>void
}
...
export const Country = ({data,setFilterValue,addMoney,removeMoney}:CountryPropsType) => {
    ...
    const addMoneyHandler=(filterValue:BanknotsType)=>{
        addMoney(filterValue)
    }
    const removeMoneyHandler=(filterValue:BanknotsType)=>{
